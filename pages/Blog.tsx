        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {posts.map((post, index) => (
            <ScrollReveal key={post.id} direction="up" delay={index * 150}>
              <article className="glass rounded-2xl shadow-lg border border-white/10 overflow-hidden hover:shadow-2xl transition-all duration-500 flex flex-col group">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <h2 className="text-xl font-bold text-white mb-3 hover:text-paroblue cursor-pointer transition-colors group-hover:text-paroblue">
                    {post.title}
                  </h2>
                  ...
                  <div className="flex items-center justify-between border-t border-white/5 pt-4 mt-auto">
                    <div className="flex items-center gap-2 text-xs text-slate-500 group-hover:text-paroblue transition-colors">
                      <div className="bg-white/5 p-1 rounded-full group-hover:bg-paroblue group-hover:text-white transition-all">
                        <User size={12} />
                      </div>
